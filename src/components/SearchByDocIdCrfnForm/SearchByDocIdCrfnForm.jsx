// src/components/SearchByDocId_CRFNform/SearchByDocId_CRFNform.jsx
import React, { useState } from 'react';
import { fetchRealPropertyPartiesData } from '../../api/api';

const SearchByDocId_CRFNform = ({ setData, setError, colorClass }) => {
...
export default SearchByDocId_CRFNform;