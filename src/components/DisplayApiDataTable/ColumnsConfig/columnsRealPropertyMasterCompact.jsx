// src/components/DisplayApiDataTable/ColumnsConfig/columnsRealPropertyMasterCompact.jsx
...
const shouldDisplayReelColumns = (data) => {
    return data.some(row => row.reel_yr !== "0" || row.reel_nbr !== "0" || row.reel_pg !== "0");
};

export const getColumnsRealPropertyMasterCompact = (data) => {
    const columns = [
        {
            Header: 'Document ID',
    ...
    if (shouldDisplayReelColumns(data)) {
        columns.push(
            {
                Header: 'Reel Year',
                accessor: 'reel_yr',
                Cell: ({ value, column }) => (
                    <>
                        ...
                        {value === "0" ? <span className="no-api-data-in-response" aria-live="polite">No Reel Year Data</span> : value}
                    </>
                ),
            },
            {
                ...
                Cell: ({ value, column }) => (
                    <>
                        ...
                        {value === "0" ? <span className="no-api-data-in-response" aria-live="polite">No Reel Number Data</span> : value}
                    </>
                ),
            },
            {
                ...
                Cell: ({ value, column }) => (
                    <>
                        ...
                        {value === "0" ? <span className="no-api-data-in-response" aria-live="polite">No Reel Page Data</span> : value}
                    </>
                ),
            }
        );
